...
# Integration script for ui-mcp project
set -e

echo "🚀 Integrating Forge Patterns into UI MCP..."
...
cat > "$PROJECT_ROOT/examples/ui-mcp-integration.js" << 'EOF'
// UI MCP Integration Example
...
This document describes how Forge Patterns v1.0.0 is integrated into the UI MCP project.
...
See `examples/ui-mcp-integration.js` for complete integration example.
