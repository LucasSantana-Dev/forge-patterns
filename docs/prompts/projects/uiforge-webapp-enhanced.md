...
Skill-enhanced prompt templates for UIForge WebApp development, integrating
Next.js best practices, Supabase optimization, UI/UX design, and frontend design
expertise.

## 🚀 Next.js 16 Development Prompts
...
You are a Next.js specialist working on the UIForge WebApp. Implement
[feature/page] with [requirements].
...
IMPLEMENTATION STANDARDS: ✅ FILE CONVENTIONS:
...
NEXT.JS SPECIFICS: ✅ ROUTE STRUCTURE:
...
You are creating a [component] for the UIForge WebApp using shadcn/ui. Implement
...
COMPONENT DESIGN STANDARDS: ✅ AESTHETIC DIRECTION:
...
SHADCN/UI SPECIFICS: ✅ COMPONENT PATTERNS:
...
## 🗄️ Supabase Integration Prompts
...
You are designing a database schema for the UIForge WebApp. Create
[schema/tables] for [feature/requirements].
...
DATABASE DESIGN PRINCIPLES: ✅ QUERY PERFORMANCE:
...
SUPABASE SPECIFICS: ✅ TABLE DESIGN:
...
You are implementing authentication for the UIForge WebApp. Create [auth
...
AUTHENTICATION STANDARDS: ✅ SECURITY IMPLEMENTATION:
...
SUPABASE AUTH SPECIFICS: ✅ PROVIDER CONFIGURATION:
...
You are designing a [component/page] for the UIForge WebApp. Create [design]
with [requirements].
...
DESIGN EXECUTION STANDARDS: ✅ AESTHETIC INNOVATION:
...
UI/UX PRO MAX APPLICATION: ✅ ADVANCED PATTERNS:
...
You are implementing a design system for the UIForge WebApp. Create [design
tokens/components] with [requirements].
...
SYSTEM DESIGN STANDARDS: ✅ DESIGN TOKENS:
...
COMPOSITION PATTERNS APPLICATION: ✅ MAINTAINABLE COMPONENTS:
...
You are optimizing the UIForge WebApp for Core Web Vitals. Improve
[metric/component] for [performance goal].
...
CORE WEB VITALS STANDARDS: ✅ LARGEST CONTENTFUL PAINT (LCP):
...
NEXT.JS PERFORMANCE PATTERNS: ✅ BUNDLE OPTIMIZATION:
...
REACT PERFORMANCE PATTERNS: ✅ COMPONENT OPTIMIZATION:
...
You are troubleshooting the UIForge WebApp. The [component/page/feature] is
experiencing [specific issue/error].
...
NEXT.JS SPECIFICS: ✅ ROUTING ISSUES:
...
1. **Apply Next.js Best Practices**: Always use @[/next-best-practices] for file
   conventions and patterns
2. **Leverage Supabase Optimization**: Apply
   @[/supabase-postgres-best-practices] for database patterns
3. **Focus on UI/UX Excellence**: Use @[/ui-ux-pro-max] and @[/frontend-design]
   for distinctive interfaces
4. **Optimize Performance**: Apply @[/vercel-react-best-practices] for
   performance optimization

### **For Component Development**

1. **Design with Distinction**: Avoid generic templates, create memorable
   interfaces
2. **Ensure Accessibility**: Meet WCAG AAA compliance across all components
3. **Apply Composition Patterns**: Use @[/vercel-composition-patterns] for
   maintainable code
...
2. **Implement Security**: Use comprehensive RLS policies and proper
   authentication
3. **Handle Real-time**: Design efficient subscription patterns
4. **Optimize Data Flow**: Use proper caching and fetching strategies

These enhanced prompts leverage Next.js best practices, Supabase optimization,
UI/UX design expertise, and frontend design principles to create distinctive,
high-performance web applications that excel in both functionality and user
experience.
