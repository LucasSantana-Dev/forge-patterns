...
Skill-enhanced prompt templates for UIForge MCP development, integrating Vercel
composition patterns, systematic debugging, MCP docs search, and brainstorming
capabilities.

## 🏗️ Service Layer Architecture Prompts
...
You are a Node.js/TypeScript specialist working on the UIForge MCP. The
[service/module] needs [refactoring/optimization].
...
REFACTORING METHODOLOGY: ✅ SERVICE ANALYSIS:
...
COMPOSITION PATTERNS APPLICATION: ✅ MAINTAINABLE SERVICES:
...
You are working on the UIForge MCP generator factory. The [generator/framework]
needs [enhancement/optimization].
...
GENERATOR ENHANCEMENT STANDARDS: ✅ FACTORY PATTERN:
...
COMPOSITION PATTERNS: ✅ FLEXIBLE GENERATORS:
...
FRAMEWORK SPECIFICS: ✅ REACT GENERATOR:
...
## 🤖 ML Pipeline Integration Prompts
...
You are enhancing the UIForge MCP ML pipeline. The [component/feature] needs
...
ML PIPELINE STANDARDS: ✅ EMBEDDING OPTIMIZATION:
...
You are implementing a new MCP tool for the UIForge MCP. Create [tool] with
...
MCP TOOL STANDARDS: ✅ TOOL ARCHITECTURE:
...
TOOL SPECIFICS: ✅ PARAMETER HANDLING:
...
## 🔄 Framework Parity Maintenance Prompts
...
You are maintaining framework parity in the UIForge MCP. Ensure
[feature/capability] works consistently across [frameworks].
...
PARITY MAINTENANCE STANDARDS: ✅ API CONSISTENCY:
...
FRAMEWORK-SPECIFIC IMPLEMENTATION: ✅ REACT PARITY:
...
You are implementing testing for the UIForge MCP. Create [test suite/strategy]
...
TESTING STANDARDS: ✅ UNIT TESTING:
...
You are optimizing the UIForge MCP performance. Improve [component/metric] for
[performance goal].
...
PERFORMANCE STANDARDS: ✅ CODE OPTIMIZATION:
...
1. **Apply Composition Patterns**: Use @[/vercel-composition-patterns] for
   maintainable services
2. **Use Systematic Debugging**: Apply @[/systematic-debugging] for all
   troubleshooting
3. **Leverage MCP Knowledge**: Use @[/skill-mcp-docs-search] and
   @[/mcp-docs-and-tools]
4. **Innovate with Brainstorming**: Apply @[/brainstorming] for design and
...
These enhanced prompts leverage composition patterns, systematic debugging, MCP
expertise, and brainstorming to create robust, maintainable, and innovative MCP
server implementations that excel in functionality and performance.
